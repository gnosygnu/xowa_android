...
//			try {return Bry_.new_u8(String_.Concat(http_file_str, java.net.URLEncoder.encode(raw, "UTF-8")));}	//#<>System.Web.HttpUtility.UrlEncode(raw)~java.net.URLEncoder.encode(raw, "UTF-8")
