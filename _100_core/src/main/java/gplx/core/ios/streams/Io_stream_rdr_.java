...
public class Io_stream_rdr_ {
	...
	public static Io_stream_rdr		New__raw(java.io.InputStream strm)	{return new Io_stream_rdr__raw().Under_(strm);}	//#<>System.IO.Stream~java.io.InputStream
	...
	public static java.io.InputStream New__mem_as_stream(byte[] v) {	//#<>System.IO.Stream~java.io.InputStream
	...
	public static int Read_by_parts(java.io.InputStream stream, int part_len, byte[] bry, int bgn, int len) {//#<>System.IO.Stream~java.io.InputStream
		/*
	...
	public static boolean Close(java.io.InputStream stream) {	//#<>System.IO.Stream~java.io.InputStream
		try {
			if (stream != null) stream.close();	//#<>.Close~.close
			return true;
