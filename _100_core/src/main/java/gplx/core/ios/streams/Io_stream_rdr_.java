...
public class Io_stream_rdr_ {
	...
	public static Io_stream_rdr file_(java.io.InputStream strm)	{return new Io_stream_rdr_file().Under_(strm);}	//#<>System.IO.Stream~java.io.InputStream
	...
	public static java.io.InputStream Stream_new_mem(byte[] v) {	//#<>System.IO.Stream~java.io.InputStream
		return new java.io.ByteArrayInputStream(v);					//#<>System.IO.MemoryStream~java.io.ByteArrayInputStream
	}
	public static boolean Stream_close(java.io.InputStream stream) {	//#<>System.IO.Stream~java.io.InputStream
		try {
			if (stream != null)
				stream.close();									//#<>.Close~.close
			return true;
		} catch (Exception e) {Err_.Noop(e); return false;}
	}
	public static int Stream_read_by_parts(java.io.InputStream stream, int part_len, byte[] bry, int bgn, int len) {//#<>System.IO.Stream~java.io.InputStream
		/*
		...
		*/
		try {
			...
			while (true) {
				...
				int read = stream.read(bry, cur, bry_len);		//#<>.Read~.read
...
class Io_stream_rdr_adp implements Io_stream_rdr {
	...
	public Io_stream_rdr_adp(java.io.InputStream strm) {this.strm = strm;} //#<>System.IO.Stream~java.io.InputStream
