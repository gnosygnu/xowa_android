...
public class Bry_bfr {
	...
	public Bry_bfr Add_str_u8(String str) {
		try {
			int str_len = str.length();							//#<>length~length()
	...
	public Bry_bfr Add_str_a7(String str) {
		try {
			int bry_len = str.length();						//#<>length~length()
			if (bfr_len + bry_len > bfr_max) Resize((bfr_max + bry_len) * 2);
			for (int i = 0; i < bry_len; ++i) {
				char c = str.charAt(i);							//#<>str[i]~str.charAt(i)
				if (c > 128) c = '?';
	...
	public Bry_bfr Add_obj(Object o) {
		...
		else if	(o_type == Integer.class)         Add_int_variable(Int_.cast(o));    //#<>typeof(int    )~typeof(Integer)
		else if	(o_type == Byte.class)            Add_byte(Byte_.cast(o));           //#<>typeof(byte)~typeof(Byte)
		else if	(o_type == Long.class)            Add_long_variable(Long_.cast(o));  //#<>typeof(long)~typeof(Long)
		...
		else if	(o_type == Boolean.class)			Add_yn(Bool_.cast(o));				//#<>typeof(boolean)~Boolean.class
		else if	(o_type == Double.class)			Add_double(Double_.cast(o));		//#<>typeof(double)~Double.class
		else if	(o_type == Float.class)			Add_float(Float_.cast(o));			//#<>typeof(float)~Float.class
	...
	public Bry_bfr Add_obj_strict(Object o) {
		...
		else if	(o_type == Boolean.class)			Add_bool(Bool_.cast(o));			//#<>typeof(boolean)~Boolean.class
		else if	(o_type == Double.class)			Add_double(Double_.cast(o));		//#<>typeof(double)~Double.class
		else if	(o_type == Float.class)			Add_float(Float_.cast(o));			//#<>typeof(float)~Float.class
		else										((Bfr_arg)o).Bfr_arg__add(this);
		return this;
