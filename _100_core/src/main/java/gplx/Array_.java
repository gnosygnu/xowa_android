...
public class Array_ {
	public static Object cast(Object o) {return (Object)o;}//#<>System.Array~Object
	...
	public static Object Resize_add_one(Object src, int src_len, Object new_obj) {//#<>Array~Object
		Object rv = Resize(src, src_len + 1);	//#<>Array~Object
		Set_at(rv, src_len, new_obj);
		return rv;
	}
	public static Object Resize(Object src, int trg_len) {		//#<>Array~Object
		Object trg = Create(Component_type(src), trg_len);		//#<>Array~Object
		int src_len = Array.getLength(src);								//#<>src.length~Array.getLength(src)
		int copy_len = src_len > trg_len ? trg_len : src_len;	// trg_len can either expand or shrink
		Copy_to(src, 0, trg, 0, copy_len);
		return trg;
	}
	public static List_adp To_list(Object ary) {	//#<>System.Array~Object
	...
	public static String To_str_nested_obj(Object o) {
		...
		To_str_nested_ary(bfr, (Object)o, 0);	//#<>Array~Object
		return bfr.To_str_and_clear();
	}
	private static void To_str_nested_ary(Bry_bfr bfr, Object ary, int indent) {//#<>Array~Object
		int len = Len(ary);
		for (int i = 0; i < len; i++) {
			Object itm = Get_at(ary, i);
			if (itm != null && Type_adp_.Is_array(itm.getClass()))
				To_str_nested_ary(bfr, (Object)itm, indent + 1);	//#<>Array~Object
			else {
	...
	public static String To_str_obj(Object o) {return To_str((Object)o);}	//#<>Array~Object
	public static String To_str(Object ary) {	//#<>Array~Object
