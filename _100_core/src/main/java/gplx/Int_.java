...
public class Int_ implements GfoInvkAble {//_20101128
	public static final String Cls_val_name = "int";
	public static final Class<?> Cls_ref_type = Integer.class; //#<>typeof(int)~Integer.class
	...
	public static int parse(String raw) {try {return Integer.parseInt(raw);} catch(Exception e) {throw Err_.new_parse_exc(e, int.class, raw);}}//#<>int.Parse~Integer.parseInt
	public static int cast(Object obj) {try {return (Integer)obj;} catch(Exception exc) {throw Err_.new_type_mismatch_w_exc(exc, int.class, obj);}}//#<>(int)obj~(Integer)obj
	public static int cast_or(Object obj, int or) {try {return (Integer)obj;} catch(Exception e) {Err_.Noop(e); return or;}}//#<>(int)obj~(Integer)obj
	public static int Xby_double_(double v) {return (int)v;}
	public static String To_str(int v) {return new Integer(v).toString();}//#<>v.toString()~new Integer(v).toString()
	public static String To_str_fmt(int v, String fmt) {return new java.text.DecimalFormat(fmt).format(v);}//#<>v.toString(fmt)~new java.text.DecimalFormat(fmt).format(v)
	public static boolean TypeMatch(Class<?> type) {return type == int.class || type == Integer.class;}//#<>type == typeof(int)~type == int.class || type == Integer.class
	...
	public static String To_str_hex(boolean zero_pad, boolean upper, int v) {
		String rv = Integer.toHexString(v); //#<>v.toString("X")~Integer.toHexString(v)
