...
public class Err extends RuntimeException {//#<>Exception~RuntimeException
	...
	@Override public String getMessage() {return To_str__msg_only();}//#<>String Message {get {return To_str__msg_only();}}~String getMessage() {return To_str__msg_only();}
