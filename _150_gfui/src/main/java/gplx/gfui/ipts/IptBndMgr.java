...
class IptBndHash implements SrlAble {//_20110507		// for a given eventType, add bnds to hash by ipt.Key()
...
class IptBndListItm implements SrlAble {//_20110507	// for a given ipt.Key(), add bnds to list
