...
public class ImageAdp_base implements ImageAdp, Rls_able {
	...
	public int Width() {return under.getWidth(null);}	//#<>.Width~.getWidth(null)
	public int Height() {return under.getHeight(null);}	//#<>.Height~.getHeight(null)
	...
	public void Rls() {disposed = true; under.flush();}	//#<>.Dispose~.flush
