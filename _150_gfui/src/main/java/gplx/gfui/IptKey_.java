...
public class IptKey_ {
	...
	public static final IptKey 
	  None = new_(0, "none")
	, Back = new_(8, "back"), Tab = new_(9, "tab"), Clear = new_(12, "clear"), Enter = new_(KeyEvent.VK_ENTER, "enter")	//#<>(13~(KeyEvent.VK_ENTER
	, ShiftKey = new_(16, "shiftKey"), CtrlKey = new_(17, "ctrlKey"), AltKey = new_(18, "altKey")
	, Pause = new_(KeyEvent.VK_PAUSE, "pause")	//#<>(19~(KeyEvent.VK_PAUSE
	...
	, Delete = new_(KeyEvent.VK_DELETE, "delete")					//#<>(46~(KeyEvent.VK_DELETE
	...
	, Semicolon = new_(KeyEvent.VK_SEMICOLON, "semicolon")			//#<>(186~(KeyEvent.VK_SEMICOLON
	, Equal = new_(KeyEvent.VK_EQUALS, "equal")					//#<>(187~(KeyEvent.VK_EQUALS
	, Comma = new_(KeyEvent.VK_COMMA, "comma")					//#<>(188~(KeyEvent.VK_COMMA
	, Minus = new_(KeyEvent.VK_MINUS, "minus")					//#<>(189~(KeyEvent.VK_MINUS
	, Period = new_(KeyEvent.VK_PERIOD, "period")					//#<>(190~(KeyEvent.VK_PERIOD
	, Slash = new_(KeyEvent.VK_SLASH, "slash")					//#<>(191~(KeyEvent.VK_SLASH
	, Tick = new_(KeyEvent.VK_BACK_QUOTE, "tick")						//#<>(192~(KeyEvent.VK_BACK_QUOTE
	, OpenBracket = new_(219, "openBracket")
	, Backslash = new_(KeyEvent.VK_BACK_SLASH, "backslash")			//#<>(220~(KeyEvent.VK_BACK_SLASH
