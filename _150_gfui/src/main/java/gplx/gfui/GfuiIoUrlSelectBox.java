...
class IoFileSelector extends GfuiIoUrlSelectBox { //#*inherit
	@Override protected Io_url SelectAction_hook(Io_url startingFolder) {
...
class IoFolderSelector extends GfuiIoUrlSelectBox {	//#*inherit
	@Override protected Io_url SelectAction_hook(Io_url startingFolder) {
