...
import gplx.xowa.addons.bldrs.xodirs.Xobc_xodir_special;
...
import gplx.xowa.wikis.pages.tags.Xopg_tag_wtr_cbk;
...
//        Xod_asset_fsys_sync.Sync_dir(activity, media_scanner, version, app_root, "xowa", "bin", "any", "xowa", "html");
        ...
        Xobc_task_addon task_addon = (Xobc_task_addon)xo_app.Addon_mgr().Itms__get_or_null(Xobc_task_addon.ADDON__KEY);
        task_addon.Xodir_mgr_(new Xod_xodir_mgr__drd(context, xo_app));
