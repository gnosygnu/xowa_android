...
public class Drd_db_mgr extends SQLiteOpenHelper {
    ...
    public static void Setup(Context context) {
        ...
        Drd_db_engine prototype = new Drd_db_engine(null);
...
class Drd_db_rdr implements Db_rdr {
    ...
    public Object 		Read_at(int k)				    {return cursor.getString(k);}
    public void			Rls() 							{
        cursor.close();
        if (stmt != null) stmt.Rls();
    }
}
//class Drd_db_stmt_old implements Db_stmt {
...
//    public Drd_db_stmt_old(Db_engine engine, Db_qry qry, SQLiteDatabase db) {Ctor_stmt(engine, qry);}
...
//    public Db_stmt Val_rdr_(gplx.core.ios.streams.Io_stream_rdr rdr, long rdr_len) {return this;}
...
//        }
//    }
//    private final Bry_bfr tmp_bfr = Bry_bfr_.New_w_size(255); private final Bry_fmtr tmp_fmtr = new Bry_fmtr();
//    public boolean Exec_insert() {
//		Db_qry_insert qry = (Db_qry_insert)qry_obj;
//		int len = list.Count();
//        Object[] bind_args = new Object[len];
//		for (int i = 0; i < len; ++i)
//            bind_args[i] = list.Get_at(i);
//
//        String sql = Sql_qry_wtr_.Sqlite.To_sql_str(qry, true);
//        db.execSQL(sql, bind_args);
//        return true;
//    }
