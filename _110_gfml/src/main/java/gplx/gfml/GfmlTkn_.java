...
public class GfmlTkn_ {//_20101204
...
class GfmlTkn_base implements GfmlTkn {//_20101204
...
class GfmlTkn_valConst extends GfmlTkn_base {//_20101204	// .MakeNew() always returns same .Val
...
class GfmlTkn_singleton extends GfmlTkn_base {//_20101204	// .MakeNew() always returns self
	@Override public GfmlTkn MakeNew(String rawNew, String valNew) {return this;}
}
class GfmlTkn_composite implements GfmlTkn {//_20101204
	public int ObjType() {return GfmlObj_.Type_tkn;}
	public String TknType() {return tknType;} private String tknType;
