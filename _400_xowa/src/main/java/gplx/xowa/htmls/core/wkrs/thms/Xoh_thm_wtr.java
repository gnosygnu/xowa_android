...
public class Xoh_thm_wtr implements gplx.core.brys.Bfr_arg {
	...
	public Xoh_thm_wtr Clear() {
		Bfr_arg_.Clear(div_0_align, div_1_id, div_2_href, capt_2); // , div_1_width, div_2_magnify
	...
	public void Write(Bry_bfr bfr, Xoh_page hpg, Xoh_hdoc_ctx hctx, byte[] src, boolean img_is_vid, int div_0_align, int div_1_w, Xoh_img_wtr img_wtr, byte[] div_2_href
		, Bfr_arg capt_1, boolean capt_2_exists, boolean capt_2_is_tidy, byte[] capt_2_bry) {
		this.Clear();
	...
	public void Bfr_arg__add(Bry_bfr bfr) {
		fmtr.Bld_bfr_many(bfr, div_0_align, div_1_id, div_1_width, img_is_vid_nl, div_1_img, trailing_space, div_2_href, div_2_magnify, capt_1, capt_2);
	}
	...
	,       "<div class=\"magnify\"><a~{div_2_href} class=\"inte"+"rnal\" title=\"Enlarge\"></a></div>"
	,       "~{capt_1}</div>~{capt_2}</div>"
	, "</div>"
	), "div_0_align", "div_1_id", "div_1_width", "img_is_vid_nl", "div_1_img", "trailing_space", "div_2_href", "div_2_magnify", "capt_1", "capt_2");
