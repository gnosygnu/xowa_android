...
public class Xoh_img_data implements Xoh_data_itm {
	...
	public void Clear() {
		...
		this.img_is_vid = img_wo_anch = false;
	...
	public boolean Init_by_parse(Xoh_hdoc_wkr hdoc_wkr, Xoh_hdoc_ctx hctx, Gfh_tag_rdr tag_rdr, byte[] src, Gfh_tag anch_head, Gfh_tag unused) {
		...
		if (anch_head.Name_id() == Gfh_tag_.Id__img) {
	...
	public void Init_by_decode(boolean anch_rel_is_nofollow, int anch_title_bgn, int anch_title_end, boolean img_wo_anch, boolean img_is_vid, int img_w, int img_h, int img_alt_bgn, int img_alt_end) {
