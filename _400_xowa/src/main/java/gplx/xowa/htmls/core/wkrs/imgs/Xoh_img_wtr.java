...
public class Xoh_img_wtr implements Bfr_arg, Xoh_wtr_itm {
	...
	public boolean Init_by_decode(Xoh_page hpg, Xoh_hdoc_ctx hctx, byte[] src, Xoh_data_itm data_itm) {
		...
		if		(data.Img_pgbnr().Exists()) {
			...
			fsdb_itm.Init_at_lnki(Xof_exec_tid.Tid_wiki_page, hctx.Cache__wiki_abrv(img_src_data.Repo_is_commons()), lnki_ttl, Xop_lnki_type.Tid_orig_known, Xop_lnki_tkn.Upright_null, file_w, Xof_img_size.Null, Xof_lnki_time.Null_as_int, Xof_lnki_page.Null, Xof_patch_upright_tid_.Tid_all);
