...
class Xoi_cmd_imageMagick_download extends Gfo_thread_cmd_download implements Gfo_thread_cmd {//#*inherit
//		private static final    byte[] Bry_windows_zip = Bry_.new_a7("-windows.zip");
