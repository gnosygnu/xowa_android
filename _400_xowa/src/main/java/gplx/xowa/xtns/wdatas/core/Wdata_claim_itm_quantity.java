...
public class Wdata_claim_itm_quantity extends Wdata_claim_itm_core { //#*inherit
	public Wdata_claim_itm_quantity(int pid, byte snak_tid, byte[] amount, byte[] unit, byte[] ubound, byte[] lbound) {
