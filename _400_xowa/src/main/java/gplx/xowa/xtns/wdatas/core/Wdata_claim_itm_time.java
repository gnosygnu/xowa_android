...
public class Wdata_claim_itm_time extends Wdata_claim_itm_core { //#*inherit
	public Wdata_claim_itm_time(int pid, byte snak_tid, byte[] time, byte[] timezone, byte[] before, byte[] after, byte[] precision, byte[] calendar) {
