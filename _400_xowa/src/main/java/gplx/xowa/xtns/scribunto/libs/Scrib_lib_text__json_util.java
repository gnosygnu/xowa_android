...
class Scrib_lib_text__json_util {
	...
	public void Reindex_arrays(Scrib_lib_text__reindex_data rv, KeyVal[] kv_ary, boolean is_encoding) {
		...
		if (is_sequence) {
			if (is_encoding) {
				Object rv_as_ary = To_array_values(kv_ary);	//#<>System.Array~Object
	...
	private Object Decode_ary(Json_ary ary) {
		int len = ary.Len();
		Object rv = Array_.Create(Object.class, len);//#<>System.Array~Object
		for (int i = 0; i < len; ++i) {
	...
	public byte[] Encode_as_ary(Object ary, int flag, int skip) {//#<>System.Array~Object
		synchronized (wtr ) {
	...
	private void Encode_kv(KeyVal kv) {
		...
		if		(Type_adp_.Eq(type, KeyVal[].class)) {
			...
			wtr.Ary_bgn(kv.Key());
			Encode_ary(kv_val);//#<>(System.Array)~
			wtr.Ary_end();
		}
	...
	private void Encode_ary(Object ary) {//#<>System.Array~Object
...
class Scrib_lib_text__reindex_data {
	...
	public Object		Rv_as_ary() {return rv_as_ary;} private Object rv_as_ary;	//#<>System.Array~Object
	public void Init(boolean rv_is_kvy, KeyVal[] rv_as_kvy, Object rv_as_ary) {//#<>System.Array~Object
