...
import gplx.xowa.addons.searchs.suggests.*; import gplx.xowa.addons.searchs.v1s.*;
import gplx.xowa.specials.*;
public class Srch_special_mgr implements Xows_page, GfoInvkAble, GfoEvObj {
	...
	public Srch_special_mgr(Xowe_wiki wiki) {
		this.app = wiki.Appe();
