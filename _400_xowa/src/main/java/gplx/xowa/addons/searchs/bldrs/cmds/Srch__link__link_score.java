package gplx.xowa.addons.searchs.bldrs.cmds; import gplx.*; import gplx.xowa.*; import gplx.xowa.addons.*; import gplx.xowa.addons.searchs.*; import gplx.xowa.addons.searchs.bldrs.*;
...
public class Srch__link__link_score extends Xob_cmd__base implements Xob_cmd {
	...
	@Override public void Cmd_run() {
		...
		for (int i = 0; i < link_tbls_len; ++i) {
			...
			link_tbl.conn.Env_vacuum();
			word_tbl.Create_idx__min_max();
		}
		Srch_db_cfg_.Update_link(search_db_mgr.Tbl__cfg(), search_db_mgr.Cfg(), link_score_max);
	}
