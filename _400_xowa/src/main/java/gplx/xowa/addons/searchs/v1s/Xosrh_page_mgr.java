...
public class Xosrh_page_mgr implements Xosrh_page_mgr_searcher {
	...
	public Srch_ns_mgr Ns_mgr() {return ns_mgr;} public void Ns_mgr_(Srch_ns_mgr v) {ns_mgr = v;} private Srch_ns_mgr ns_mgr = new Srch_ns_mgr();
	...
	public List_adp Parse_search_and_load_ids(Cancelable cancelable, Bry_bfr bfr, Srch_ns_mgr ns_mgr, byte[] search) {
