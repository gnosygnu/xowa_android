...
public class Srch_rslt_cbk__html implements Srch_rslt_cbk {
	...
	public Srch_rslt_cbk__html(Cancelable cxl, Srch_html_row_bldr html_row_bldr, Xog_js_wkr js_wkr, int slab_len, byte[] wiki) {			
		this.cxl = cxl;
