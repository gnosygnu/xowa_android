...
public class Srch_page_rank_cmd extends Xob_cmd__base implements Xob_cmd {	// create page_rank in page_db; drop and vaccuum later; avoid cross db for now
	...
	public Srch_page_rank_cmd(Xob_bldr bldr, Xowe_wiki wiki) {super(bldr, wiki);}
	public Srch_page_rank_cmd Iteration_max_(int iteration_max) {this.iteration_max = iteration_max; return this;}
	@Override public String Cmd_key() {return Xob_cmd_keys.Key_search_page_rank;}
	...
	private void Init__tbl() {
		...
		, Dbmeta_fld_itm.new_bool		(Pagerank__fld_has_converged).Default_(0)
	...
	private void Calc__main() {
		...
		Gfo_usr_dlg_.Instance.Prog_many("", "", "page_rank done; iteration=~{0}", iteration_idx);
	}
