...
import gplx.xowa.bldrs.cmds.ctgs.*; import gplx.xowa.wikis.ctgs.*; import gplx.xowa.addons.searchs.v1s.*; import gplx.core.encoders.*;
...
public class Xodb_load_mgr_txt implements Xodb_load_mgr {
	...
	public void Load_search(Cancelable cancelable, List_adp rv, byte[] search, int results_max) {
		...
		if (match_tid == Srch_special_mgr.Match_tid_all) {
