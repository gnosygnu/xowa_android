...
import gplx.xowa.specials.allPages.*; import gplx.xowa.addons.searchs.v1s.*; import gplx.xowa.specials.nearby.*; import gplx.xowa.specials.randoms.*; import gplx.xowa.specials.statistics.*; import gplx.xowa.xtns.translates.*; import gplx.xowa.specials.movePage.*;
...
public class Xows_mgr {
	...
	public Xows_mgr(Xowe_wiki wiki, Xol_lang_itm lang) {
		...
		page_search = new Srch_special_mgr(wiki);
	...
	public Srch_special_mgr				Page_search() {return page_search;} private final Srch_special_mgr page_search;
