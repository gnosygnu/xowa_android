...
import java.sql.*;	//#<>using System.Data~import java.sql.*
...
public class Db_stmt_cmd implements Db_stmt {
	...
	private PreparedStatement stmt = null;	//#<>IDbCommand~PreparedStatement
	...
	public Db_stmt Reset_stmt() {
		stmt = (PreparedStatement)engine.New_stmt_prep_as_obj(sql);	//#<>IDbCommand~PreparedStatement
		return this;
	}
	...
	private Db_stmt Add_byte(boolean where, String k, byte v) {
		...
		try {stmt.setByte(++val_idx, v);} catch (Exception e) {this.Rls(); throw Err_.new_exc(e, "db", "failed to add value", "type", "byte", "val", v, "sql", sql);}	//#<>Parameters_add(Db_val_type.Tid_byte, ~stmt.setByte(++val_idx, 
		return this;
	}
	...
	private Db_stmt Add_int(boolean where, String k, int v) {
		if (k == Dbmeta_fld_itm.Key_null) return this;	// key is explicitly null; ignore; allows version_2+ type definitions
		try {stmt.setInt(++val_idx, v);} catch (Exception e) {this.Rls(); throw Err_.new_exc(e, "db", "failed to add value", "type", "int", "val", v, "sql", sql);}	//#<>Parameters_add(Db_val_type.Tid_int32, ~stmt.setInt(++val_idx, 
		return this;
	}
	...
	private Db_stmt Add_long(boolean where, String k, long v) {
		if (k == Dbmeta_fld_itm.Key_null) return this;	// key is explicitly null; ignore; allows version_2+ type definitions
		try {stmt.setLong(++val_idx, v);} catch (Exception e) {this.Rls(); throw Err_.new_exc(e, "db", "failed to add value", "type", "long", "val", v, "sql", sql);}	//#<>Parameters_add(Db_val_type.Tid_int64, ~stmt.setLong(++val_idx, 
		return this;
	}
	...
	private Db_stmt Add_float(boolean where, String k, float v) {
		if (k == Dbmeta_fld_itm.Key_null) return this;	// key is explicitly null; ignore; allows version_2+ type definitions
		try {stmt.setFloat(++val_idx, v);} catch (Exception e) {this.Rls(); throw Err_.new_exc(e, "db", "failed to add value", "type", "float", "val", v, "sql", sql);}	//#<>Parameters_add(Db_val_type.Tid_float, ~stmt.setFloat(++val_idx, 
		return this;
	}
	...
	private Db_stmt Add_double(boolean where, String k, double v) {
		if (k == Dbmeta_fld_itm.Key_null) return this;	// key is explicitly null; ignore; allows version_2+ type definitions
		try {stmt.setDouble(++val_idx, v);} catch (Exception e) {this.Rls(); throw Err_.new_exc(e, "db", "failed to add value", "type", "double", "val", v, "sql", sql);}	//#<>Parameters_add(Db_val_type.Tid_double, ~stmt.setDouble(++val_idx, 
		return this;
	}
	...
	private Db_stmt Add_decimal(boolean where, String k, Decimal_adp v) {
		if (k == Dbmeta_fld_itm.Key_null) return this;	// key is explicitly null; ignore; allows version_2+ type definitions
		try {stmt.setBigDecimal(++val_idx, v.Under_as_native());} catch (Exception e) {this.Rls(); throw Err_.new_exc(e, "db", "failed to add value", "type", "decimal", "val", v, "sql", sql);}	//#<>Parameters_add(Db_val_type.Tid_decimal, ~stmt.setBigDecimal(++val_idx, 
		return this;
	}
	...
	private Db_stmt Add_bry(boolean where, String k, byte[] v) {
		if (k == Dbmeta_fld_itm.Key_null) return this;	// key is explicitly null; ignore; allows version_2+ type definitions
		try {stmt.setBytes(++val_idx, v);} catch (Exception e) {this.Rls(); throw Err_.new_exc(e, "db", "failed to add value", "type", "byte[]", v.length, sql);}	//#<>Parameters_add(Db_val_type.Tid_bry, ~stmt.setBytes(++val_idx, 
		return this;
	}
	...
	@gplx.Virtual protected Db_stmt Add_str(boolean where, String k, String v) {
		if (k == Dbmeta_fld_itm.Key_null) return this;	// key is explicitly null; ignore; allows version_2+ type definitions
		try {stmt.setString(++val_idx, v);} catch (Exception e) {this.Rls(); throw Err_.new_exc(e, "db", "failed to add value", "type", "String", "val", v, "sql", sql);}	//#<>Parameters_add(Db_val_type.Tid_nvarchar, ~stmt.setString(++val_idx, 
		return this;
	}
	...
	@gplx.Virtual protected Db_stmt Add_date(boolean where, String k, DateAdp v) {
		if (k == Dbmeta_fld_itm.Key_null) return this;	// key is explicitly null; ignore; allows version_2+ type definitions
		try {stmt.setTimestamp(++val_idx, new java.sql.Timestamp(v.UnderDateTime().getTime().getTime()));} catch (Exception e) {this.Rls(); throw Err_.new_exc(e, "db", "failed to add value", "type", "date", "val", v, "sql", sql);}	//#<>Parameters_add(Db_val_type.Tid_date, v)~stmt.setTimestamp(++val_idx, new java.sql.Timestamp(v.UnderDateTime().getTime().getTime()))
		return this;
	}
	...
	private Db_stmt Add_text(boolean where, String k, String v) {
		if (k == Dbmeta_fld_itm.Key_null) return this;	// key is explicitly null; ignore; allows version_2+ type definitions
		try {stmt.setString(++val_idx, v);} catch (Exception e) {this.Rls(); throw Err_.new_exc(e, "db", "failed to add value", "type", "text", "val", v, "sql", sql);}	//#<>Parameters_add(Db_val_type.Tid_text, ~stmt.setString(++val_idx, 
		return this;
	}
	public Db_stmt Val_rdr_(gplx.core.ios.Io_stream_rdr v, long rdr_len) {
		try {stmt.setBinaryStream(++val_idx, (java.io.InputStream)v.Under(), (int)rdr_len);} catch (Exception e) {throw Err_.new_exc(e, "db", "failed to add value", "type", "rdr", "val", v);}	//#<>Parameters_add(Db_val_type.Tid_rdr, v~stmt.setBinaryStream(++val_idx, (java.io.InputStream)v.Under(), (int)rdr_len
		return this;
	}
	public boolean Exec_insert() {
		try		{boolean rv = stmt.execute(); return rv;}	//#<>.ExecuteNonQuery() > 0;~.execute();
		catch (Exception e) {
			this.Rls();
			Reset_stmt();
	...
	public int Exec_update() {
		try		{int rv = stmt.executeUpdate(); return rv;}		//#<>.ExecuteNonQuery();~.executeUpdate();
		catch (Exception e) {
			this.Rls();
			Reset_stmt();
	...
	public DataRdr Exec_select() {
		try {DataRdr rv = engine.New_rdr(stmt.executeQuery(), sql); return rv;} catch (Exception e) {throw Err_.new_exc(e, "db", "failed to exec prepared statement", "sql", sql);}	//#<>.ExecuteReader()~.executeQuery()
	}
	public Db_rdr Exec_select__rls_auto() {
		try {return engine.New_rdr__rls_auto(this, stmt.executeQuery(), sql);}	catch (Exception e) {throw Err_.new_exc(e, "db", "select failed", "sql", sql);}	//#<>.ExecuteReader()~.executeQuery()
	}
	public Db_rdr Exec_select__rls_manual() {
		try {return engine.New_rdr__rls_manual(stmt.executeQuery(), sql);}	catch (Exception e) {throw Err_.new_exc(e, "db", "select failed", "sql", sql);}	//#<>.ExecuteReader()~.executeQuery()
	}
	public Object Exec_select_val() {
		try {Object rv = DataRdr_.Read_1st_row_and_1st_fld(engine.New_rdr(stmt.executeQuery(), sql)); return rv;} catch (Exception e) {throw Err_.new_exc(e, "db", "failed to exec prepared statement", "sql", sql);}	//#<>.ExecuteReader()~.executeQuery()
	}
	public Db_stmt Clear() {
		val_idx = 0;
		try {stmt.clearBatch();}	//#<>.Parameters.Clear~.clearBatch
