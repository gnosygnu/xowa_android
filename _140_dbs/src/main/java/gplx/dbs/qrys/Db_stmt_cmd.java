...
public class Db_stmt_cmd implements Db_stmt {
	...
	public Db_stmt Reset_stmt() {
		stmt = (PreparedStatement)engine.Stmt_by_sql(sql);	//#<>IDbCommand~PreparedStatement
		return this;
	}
	...
	public Db_rdr Exec_select__rls_auto() {
		try {return engine.Exec_as_rdr__rls_auto(this, stmt.executeQuery(), sql);}	catch (Exception e) {throw Err_.new_exc(e, "db", "select failed", "sql", sql);}	//#<>.ExecuteReader()~.executeQuery()
	}
	public Db_rdr Exec_select__rls_manual() {
		try {return engine.Exec_as_rdr__rls_manual(stmt.executeQuery(), sql);}	catch (Exception e) {throw Err_.new_exc(e, "db", "select failed", "sql", sql);}	//#<>.ExecuteReader()~.executeQuery()
	}
