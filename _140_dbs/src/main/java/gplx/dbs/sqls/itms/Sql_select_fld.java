...
class Sql_select_fld_wild extends Sql_select_fld {	//#*inherit
	Sql_select_fld_wild() {super(Sql_select_fld.Tbl__null, Fld__wildcard, Fld__wildcard);}
...
class Sql_select_fld_col extends Sql_select_fld {		//#*inherit
	public Sql_select_fld_col(String tbl, String fld, String alias) {super(tbl, fld, alias);}
