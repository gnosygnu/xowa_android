...
class Sql_val_wtr_sqlite extends Sql_val_wtr {//#*inherit
	@Override public void Bld_val__bool(Bry_bfr bfr, boolean val) {
		bfr.Add_int_digits(1, val ? 1 : 0);	// NOTE: save boolean to 0 or 1 b/c sqlite doesn't support true / false
	}
}
class Sql_val_wtr_mysql extends Sql_val_wtr {//#*inherit
	@Override public void Bld_val__str(Bry_bfr bfr, String val) {
